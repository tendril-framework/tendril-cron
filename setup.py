...
setup(
    ...
    description="Cron Infrastructure for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-cron',
    project_urls={
        'Documentation': 'https://tendril-cron.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-cron/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-cron',
    },
    ...
    entry_points={
        'console_scripts': [
            'tendril-cron = tendril.cron.main:run',
        ]
    },
